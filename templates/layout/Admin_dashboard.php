...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="<?php $this->Url->build(['controller' => 'UrlHandler', 'action' => 'dashboard']);  ?>">Start Bootstrap</a>
    <!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="<?php $this->Url->build(['controller' => 'UrlHandler', 'action' => 'logout']);  ?>">Logout</a></li>
            </ul>
        </li>
    </ul>
</nav>
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="<?php $this->Url->build(['controller' => 'UrlHandler', 'action' => 'home']);  ?>">
                    ...
                    <a class="nav-link" href="<?php $this->Url->build(['controller' => 'UrlHandler', 'action' => 'global']);  ?>">
                        <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                        Content Management System (CMS)
                    </a>
                    <a class="nav-link" href="<?php $this->Url->build(['controller' => 'UrlHandler', 'action' => 'adduser']);  ?>">
