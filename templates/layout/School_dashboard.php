...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="School_dashboard.html">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="School_dashboard.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/buttons.html">Buttons</a>
                        <a class="collapse-item" href="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/cards.html">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/img/undraw_rocket.svg" alt="...">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile_1.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile_2.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile_3.svg"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="../../../../Desktop/school_dashboard/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg">
                            </a>
